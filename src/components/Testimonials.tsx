...
const testimonials = [
  {
    ...
    emoji: "💅",
    rating: 5,
    text: "webcraaaft transformed our salon's online presence completely. Bookings tripled within the first month! The website is stunning, loads instantly, and our clients constantly compliment how easy it is to book appointments. Worth every penny.",
    color: "#a78bfa",
  },
  {
    name: "Marco Rossi",
  ...
  },
  {
    ...
    emoji: "⚖️",
    rating: 5,
    text: "As a law firm, credibility is everything. webcraaaft delivered a site that exudes professionalism and trust. Consultation requests doubled in 6 weeks. Our competitors are still using websites from 2015 — we feel miles ahead.",
    color: "#43e8d8",
  },
  {
    name: "Aisha Patel",
